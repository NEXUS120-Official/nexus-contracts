...
contract SafeExecSetFeedScript is Script {
    address constant SAFE_ADDR = 0x8626240187bb366a8566D338b84a7F84f237164F;
    address constant ORACLE_MODULE = 0xa1BD5AF1174140caB018e46eBCFEf1d005c3df84;
    ...
    function run() external {
        ...
        console2.log("ORACLE_MODULE :", ORACLE_MODULE);
        console2.log("NEW_FEED      :", newFeed);
        console2.log("OWNER_1       :", owner1);
        console2.log("OWNER_2       :", owner2);
        console2.log("OWNER_3       :", owner3);
        console2.log("OWNER_4       :", owner4);

        bytes memory data = abi.encodeWithSignature("setFeed(address)", newFeed);
